...
import { scrollAreaConfig } from './scrollArea.ts'

const sizes = keys(scrollAreaConfig().variants.size)
const variants = keys(scrollAreaConfig().variants.variant)

type Args = ReturnType<typeof scrollArea> & {
...
export const Variants = meta.story({
  ...
  parameters: {
    tableDecorator: {
      ...
      rows: [
        {
          items: variants.map((variant) => scrollArea({ variant })),
        },
      ],
    },
  },
...
export const Sizes = meta.story({
  ...
  parameters: {
    tableDecorator: {
      ...
      rows: [
        {
          items: sizes.map((size) => scrollArea({ size, variant: 'always' })),
        },
      ],
    },
  },
