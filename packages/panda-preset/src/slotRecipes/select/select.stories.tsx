...
import { selectConfig } from './select.ts'

const sizes = keys(selectConfig().variants.size)
const variants = keys(selectConfig().variants.variant)
...
export const Variants = meta.story({
  parameters: {
    tableDecorator: {
      ...
      rows: [
        {
          items: variants.map((variant) => select({ variant })),
        },
      ],
    },
  },
...
export const Sizes = meta.story({
  parameters: {
    tableDecorator: {
      ...
      rows: [
        {
          items: sizes.map((size) => select({ size })),
        },
      ],
    },
  },
