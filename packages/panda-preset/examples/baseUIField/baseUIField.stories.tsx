...
import { baseUIField, input } from '#panda/recipes'
import preview from '#sb/preview.tsx'

type Args = Partial<ReturnType<typeof baseUIField>> & Field.Root.Props

const meta = preview.meta({
  args: { ...baseUIField(), disabled: false, invalid: false },
  argTypes: {
...
export const Horizontal = meta.story({
  args: { ...baseUIField({ orientation: 'horizontal' }), disabled: false, invalid: false },
