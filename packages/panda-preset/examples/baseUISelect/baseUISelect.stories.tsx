        ...
        <Select.Portal>
          <Select.Positioner className={positioner} sideOffset={8}>
            <Select.Popup className={popup}>
              <Select.ScrollUpArrow className={scrollUpIndicator} />
              <Select.List className={list}>
                <Select.Group className={group}>
                  <Select.GroupLabel className={groupLabel}>Group 1</Select.GroupLabel>
                  <Select.Item value={'item1'} className={item}>
                    <Select.ItemText className={itemText}>group item 1</Select.ItemText>
...
export const Variants = meta.story({
  parameters: {
    tableDecorator: {
      ...
      rows: [
        {
          items: variants.map((variant) => baseUISelect({ variant })),
        },
      ],
    },
  },
...
export const Sizes = meta.story({
  parameters: {
    tableDecorator: {
      ...
      rows: [
        {
          items: sizes.map((size) => baseUISelect({ size })),
        },
      ],
    },
  },
